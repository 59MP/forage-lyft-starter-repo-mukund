...
class TestCalliope(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.create_callipe(today, last_service_date, current_mileage, last_service_mileage)
    ...
    def test_engine_should_be_serviced(self):
        ...
        car =  CarFactory.create_callipe(last_service_date, last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
